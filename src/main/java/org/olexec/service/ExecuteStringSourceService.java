...
public class ExecuteStringSourceService {
    ...
    //jdk8加了并行计算，所以可以为cpu*2，核数/1-阻塞系数（0.8-0.9）
    //线程命名良好习惯
    //
    ...
    private static final ExecutorService pool = new ThreadPoolExecutor(N_THREAD, N_THREAD,
            60L, TimeUnit.SECONDS, new ArrayBlockingQueue<Runnable>(N_THREAD));//有界阻塞队列，保证不抛弃任何一个任务https://www.cnblogs.com/zedosu/p/6665306.html
